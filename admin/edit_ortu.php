...
$id_ortu = (int)$_GET['id'];
$query = mysqli_query($conn, "SELECT * FROM ortu WHERE id_ortu = $id_ortu");
...
<head>
  <meta charset="UTF-8">
  <title>✏️ Edit Data Orang Tua</title>
...
<div class="container mt-4">
  <div class="card shadow p-4">
    <h3 class="mb-4 text-center">✏️ Edit Data Orang Tua</h3>
    ...
    <form method="POST" enctype="multipart/form-data">
      <div class="row">
        ...
        <!-- Kolom Kanan -->
        <div class="col-md-6">
          <label class="form-label fw-semibold">Foto Orang Tua</label>
