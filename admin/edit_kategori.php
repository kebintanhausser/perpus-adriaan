...
if (!$data) {
  echo "<script>alert('Data buku tidak ditemukan!');window.location='kategori.php';</script>";
  exit;
}
      ...
      <div class="row">
        <!-- Kolom Kiri -->
          ...
          <div class="mb-3">
            ...
            <input type="text" name="kategori_buku" class="form-control" value="<?= htmlspecialchars($data['kategori_buku']); ?>" required>
          </div>
          <button type="submit" name="update" class="btn btn-success w-100 mt-3">💾 Simpan</button>
        </div>
        ...
        <div class="col-md-6">
          ...
          <div class="upload-box" onclick="document.getElementById('foto').click()">
            <?php if ($data['foto']): ?>
              <img id="preview" src="../uploads/<?= $data['foto']; ?>" alt="foto Buku">
            <?php else: ?>
